var Jcrop = function (t) {
    ...
    var i = function () {
        ...
        return r(t, [{
            ...
            key: "x1", set: function (t) {
                this.w = this.x2 - t, this.x = t
            }
        }, {
            key: "y1", set: function (t) {
    ...
    i.fromPoints = function (t, e) {
        var n = [Math.min(t[0], e[0]), Math.min(t[1], e[1]), Math.max(t[0], e[0]), Math.max(t[1], e[1])], r = n[0],
            o = n[1], a = n[2], s = n[3];
    ...
    var a = function () {
        ...
        return i(t, [{
            ...
            key: "getDragQuadrant", value: function (t, e) {
                var n = this.locked[0] - t, r = this.locked[1] - e;
                return n < 0 && r < 0 ? "br" : n >= 0 && r >= 0 ? "tl" : n < 0 && r >= 0 ? "tr" : "bl"
            }
        }, {
            key: "getMaxRect", value: function (t, e, n) {
                return o.default.getMax(Math.abs(this.locked[0] - t), Math.abs(this.locked[1] - e), n)
            }
        }, {
            key: "translateStuckPoint", value: function (t, e) {
                var n = r(this.stuck, 3), i = n[0], a = n[1], s = n[2], u = null === i ? s : i + t,
                    c = null === a ? s : a + e;
                if (u > this.sw && (u = this.sw), c > this.sh && (c = this.sh), u < 0 && (u = 0), c < 0 && (c = 0), this.aspect) {
                    var f = this.getMaxRect(u, c, this.aspect), l = r(f, 2), h = l[0], d = l[1],
                        p = this.getDragQuadrant(u, c), v = o.default.fromPoint(this.locked, h, d, p);
                    return [v.x2, v.y2]
                }
                return [u, c]
            }
        }, {
            key: "getCornerPoint", value: function (t) {
                var e = this.rect;
                switch (t) {
                    case"n":
                        return [null, e.y, e.x];
            ...
            key: "getOppositeCorner", value: function (t) {
                switch (t) {
                    case"n":
                        return "se";
                    case"s":
    ...
    }(), i = f(n(0)), o = f(n(7)), a = f(n(11)), s = f(n(4)), u = f(n(9)), c = f(n(5));
    ...
    var l = function (t) {
        ...
        return function (t, e) {
            ...
            key: "canCreate", value: function () {
                var t = this.crops.size, e = this.options;
    ...
    var r = function () {
        ...
        }(), o = p(n(0)), a = p(n(8)), s = p(n(3)), u = p(n(4)), c = p(n(2)), f = p(n(5)), l = p(n(9)), h = p(n(13)),
        d = p(n(14));
    ...
    var v = function (t) {
        ...
        return function (t, e) {
            ...
            key: "initOptions", value: function () {
                ...
                this._optconf.aspectRatio = function (e) {
                    ...
                    if (t.aspect = e || null, t.aspect && n) {
                        var i = c.default.getMax(n.w, n.h, e), o = r(i, 2), a = o[0], s = o[1];
                        t.render(c.default.fromPoint([n.x, n.y], a, s))
                    }
                }
            }
        }, {
            key: "attachToStage", value: function (t) {
            ...
            key: "nudge", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = this.el.parentElement,
            ...
            key: "createHandles", value: function () {
                ...
                return this.options.handles.forEach(function (e) {
                    ...
                    r.appendTo(t.el), (0, u.default)(r.el, function () {
                        ...
                        var r = t.el.parentElement, i = r.offsetWidth, o = r.offsetHeight;
    ...
    v.create = function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = document.createElement("div"),
    ...
    "use strict";
    var r = t.exports = {
        def: "outQuad", swing: function (t, e, n, i) {
    ...
    var u = function () {
        ...
        return r(t, [{
            ...
            key: "adjust", value: function (t) {
                var e = i.default.from(this.el), n = this.shades;
    ...
    var c = function (t) {
        ...
        return function (t, e) {
            ...
            key: "w", set: function (t) {
                this.el.style.width = t + "px"
            }
        }, {
            key: "h", set: function (t) {
                this.el.style.height = t + "px"
            }
        }, {
            key: "x", set: function (t) {
                this.el.style.left = t + "px"
            }
        }]), e
    }();
    c.create = function (t, e) {
        var n = document.createElement("div"), r = t.shadeClass || "jcrop-shade";
        return n.className = r + " " + e, new c(n).color(t.shadeColor).opacity(t.shadeOpacity)
    }, c.Manager = u, e.default = c
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.DomObj = e.Shade = e.load = e.easing = e.Sticker = e.Handle = e.Rect = e.Widget = e.Dragger = e.defaults = e.Stage = void 0, e.attach = b;
    var r = y(n(0)), i = y(n(3)), o = y(n(6)), a = y(n(15)), s = y(n(7)), u = y(n(11)), c = y(n(8)), f = y(n(4)),
        l = y(n(2)), h = y(n(5)), d = y(n(1)), p = y(n(10)), v = y(n(18));
    ...
    e.default = function (t, e, n, i) {
        var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 30,
            a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "swing", s = ["x", "y", "w", "h"],
            u = e.normalize();
    ...
    var u = function (t) {
        ...
        return function (t, e) {
            ...
            key: "initResizeObserver", value: function () {
                var t = this;
            ...
            key: "resizeToImage", value: function () {
                var t = this.getImageDimensions(), e = r(t, 2), n = e[0], i = e[1], o = this.getNaturalDimensions(),
                    a = r(o, 2), s = a[0], u = a[1];
            ...
            key: "rescaleWidgets", value: function (t, e) {
                this.crops.forEach(function (n) {
                    n.pos = n.sel.scale(t, e)
                })
            }
        }, {
            key: "getImageDimensions", value: function () {
                return [this.srcEl.width, this.srcEl.height]
            }
        }, {
            key: "getNaturalDimensions", value: function () {
    ...
    n.r(e), function (t) {
        var n = function () {
            ...
            }, a = 2, s = ["top", "right", "bottom", "left", "width", "height", "size", "weight"],
        ...
        function v(t) {
            ...
            if ("border-box" === r.boxSizing && (Math.round(s + o) !== e && (s -= p(r, "left", "right") + o), Math.round(u + a) !== n && (u -= p(r, "top", "bottom") + a)), !function (t) {
                ...
                var c = Math.round(s + o) - e, f = Math.round(u + a) - n;
        ...
        var O = "undefined" != typeof WeakMap ? new WeakMap : new n, k = function (t) {
            if (!(this instanceof k)) throw new TypeError("Cannot call a class as a function.");
            if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
            var e = c.getInstance(), n = new _(t, e, this);
            O.set(this, n)
        };
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), r.check = function (t) {
